...
def load_data(mode="train",data=[]):
    ...
    print("text 0 looks like:", " ".join(idx2word[t] for t in np.fromstring(texts[0], np.int32)))
    print("text 1 looks like:", " ".join(idx2word[t] for t in np.fromstring(texts[1], np.int32)))
    print(str(hp.labels))
